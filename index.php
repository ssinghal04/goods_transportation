...
<body style="font-family: Arial, Helvetica, sans-serif;">
    ...
    <nav class="navbar navbar-toggleable-md navbar-expand-lg navbar-default navbar-light mb-10"
        style="background-color: rgba(255, 255, 255, 0.7); margin-bottom: 20px; margin-top:10px !important;">
        <div class="container">
    ...
    <div class="container-fluid" style="width: 100%; padding: 0; margin: 0;">
        <div id="carouselwithIndicators" class="carousel slide container-fluid mt-10" data-ride="carousel"
            style="width: 85%; height: 100%; border-radius: 15px;">
            ...
            <div class=" carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block " src="Images/c2.jpg" alt="First slide"
                        style="height: 80vh; width: fit-content;">
                </div>

                <div class="carousel-item">
                    <img class="d-block " src="Images/c3.jpg" alt="Second slide"
                        style="height: 80vh; width: fit-content;">
                </div>
                <div class="carousel-item">
                    <img class="d-block " src="Images/c4.jpg" alt="Third slide"
                        style="height: 80vh; width: fit-content;">
                </div>
            </div>
    ...
    <div class="container" id="about" style="margin-top: 20px; width: 85%;">
        <div class="row">
            <div class="col-md-6 p-5"
                style="background-color: rgba(255, 255, 255, 0.7); color: black; border-radius: 15px; ">
                <h2 class="display-5 text-center mb-3 pb-2" style="border-bottom: 2px solid white;">About Us</h2>
                <p>The launch of BEAM from the house of BEAM cargo services is exclusively designed to meet the
                    commercial and personal shipment needs of our customers in both urban and rural destinations. We are
                    emerging as a top destination for courier transportation and are continuously serving our customers.
                    We constantly expand our resources to cater to our customer expectation addressing their unique
                    market needs.</p>
                <p class="pb-3" style="border-bottom: 2px solid white;">Having created a brand in the cargo industry we
                    have ventured into the courier business with the same commitment. We offer flexible and faster
                    delivery solutions. We have spread our footprints far and wide with our bouquet of products and
                    services. We deliver promptly for all your time critical projects.</p>
            </div>
            <div class="col-md-6">
    ...
    <div class="container-fluid text-center mt-5"
        style="background-color: rgba(255, 255, 255, 0.7); padding: 20px; position: relative; ">
        <div class="i-bar"
        ...
        <p class="credit" style="font-size: 20px; font-stretch: 3px; text-align: center; color: black;">© BEAM</p>
    </div>
</body>
